      ...
      <nav className="fixed top-0 left-0 w-full z-50 border-b border-white/5 glass-effect" data-purpose="main-navigation">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8 text-sm font-medium text-gray-400" data-purpose="nav-links">
            ...
            <a className="hover:text-accent transition-colors" href="#proceso">Cómo funciona</a>
          ...
          <div data-purpose="nav-cta">
            <a
              ...
              href="https://wa.me/525562189913?text=Hola,%20vi%20tu%20página%20de%20Presencia%20Digital%20y%20me%20gustaría%20recibir%20más%20información."
              target="_blank"
              rel="noreferrer"
            >
              Contactar
      ...
      <main>
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <motion.a 
                  ...
                  href="https://wa.me/525562189913?text=Hola,%20quiero%20poner%20mi%20negocio%20en%20ON"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center border border-white/5 rounded-[2.5rem] p-8 lg:p-16 bg-gradient-to-br from-white/[0.03] to-transparent shadow-[0_0_50px_rgba(204,255,0,0.05)] relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <motion.a 
                  ...
                  href="https://wa.me/525562189913?text=Hola,%20me%20interesa%20crear%20mi%20propio%20Influencer%20Digital."
                  target="_blank"
        ...
        >
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <p className="text-gray-300 text-lg mb-12 max-w-2xl mx-auto font-medium">Si tus redes se ven improvisadas, tu WhatsApp está desordenado o tus clientes se pierden entre mensajes, tu negocio pierde confianza antes de vender.</p>
            ...
            >
              {[
                { icon: Clock, title: "Perfil poco profesional", desc: "El negocio te consume. Las redes sociales siempre quedan para después." },
                { icon: Camera, title: "Fotos y contenido sin intención", desc: "Un fotógrafo sale caro y el resultado llega semanas después." },
                ...
                { icon: Boxes, title: "Contenido genérico", desc: "Las agencias tradicionales te dan lo mismo que a todos. Nosotros creamos piezas específicas para tu giro y tu cliente." }
              ].map((item, i) => (
                <motion.div 
                  key={i}
                  variants={fadeInUp}
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-300 text-lg max-w-2xl mx-auto font-medium">Ordenamos cómo se ve tu negocio, cómo te escriben y cómo atiendes a tus clientes.</p>
            </div>
            <motion.div 
              variants={staggerContainer}
              initial="initial"
            ...
            >
              {[
                { icon: Eye, title: "Presencia visual ON", desc: "Páginas y perfiles que transmiten claridad y confianza." },
                { icon: Film, title: "Contenido y reels", desc: "Contenido pensado para inspirar, conectar y generar más mensajes." },
                { icon: MessagesSquare, title: "WhatsApp Business", desc: "Organiza tus mensajes y atiende mejor sin perder oportunidades." },
                { icon: MapPin, title: "Google Maps", desc: "Aparece cuando te buscan y guía a tus clientes con más claridad." },
          ...
          <div className="max-w-7xl mx-auto px-6">
              ...
              >
                ...
                <motion.div variants={fadeInUp} className="p-8 rounded-3xl glass-effect border border-white/5 flex flex-col hover:border-white/20 transition-all group">
                  ...
                  <motion.a 
                    ...
                    href="https://wa.me/525562189913?text=Hola,%20me%20interesa%20el%20paquete%20Starter%20de%20Contenido%20IA." 
                    target="_blank" 
                    rel="noreferrer"
                  >
                    Seleccionar
                ...
                >
                  ...
                  <motion.a 
                    ...
                    href="https://wa.me/525562189913?text=Hola,%20me%20interesa%20el%20paquete%20Pro%20de%20Contenido%20IA." 
                    target="_blank" 
                    rel="noreferrer"
                  >
                    Seleccionar
                ...
                <motion.div variants={fadeInUp} className="p-8 rounded-3xl glass-effect border border-white/5 flex flex-col hover:border-white/20 transition-all">
                  ...
                  <motion.a 
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="block text-center py-4 rounded-xl border border-white/10 font-bold hover:bg-white/5 transition-all" 
                    href="https://wa.me/525562189913?text=Hola,%20me%20interesa%20el%20paquete%20Full%20Pack%20de%20Contenido%20IA." 
                    target="_blank" 
                    rel="noreferrer"
                  >
                    Seleccionar
            ...
            <div>
              <div className="text-left mb-10">
                ...
                <p className="text-gray-400">Soluciones adicionales para marcas que quieren contenido más avanzado.</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                ...
                >
                  ...
                  <motion.a 
                    ...
                    href="https://wa.me/525562189913?text=Hola,%20me%20interesa%20el%20servicio%20de%20Creación%20de%20Influencer%20Digital." 
                    target="_blank" 
                    rel="noreferrer"
                  >
                    Empezar ahora
                ...
                >
                  ...
                  <motion.a 
                    ...
                    href="https://wa.me/525562189913?text=Hola,%20me%20interesa%20el%20paquete%20de%20Influencer%20+%20Contenido." 
                    target="_blank" 
                    rel="noreferrer"
                  >
                    Seleccionar
        ...
        >
          <div className="max-w-3xl mx-auto px-6 text-center">
            <span className="text-accent text-sm font-bold tracking-widest uppercase mb-4 block">Cómo funciona</span>
            ...
            >
              {[
                { step: "01", title: "Revisamos tu presencia actual", desc: "Vemos cómo se ve tu negocio hoy en redes, WhatsApp, Google y puntos de contacto." },
                { step: "02", title: "Mejoramos cómo se ve tu negocio", desc: "Ajustamos imagen, claridad visual y mensajes para que transmitas más confianza." },
                ...
                { step: "05", title: "Medimos y ajustamos", desc: "Revisamos qué funciona y afinamos presencia, atención y seguimiento." }
              ].map((item, i) => (
                <motion.div 
                  key={i}
                  variants={fadeInUp}
        ...
        >
          ...
          <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
            <h2 className="font-heading text-5xl md:text-7xl font-extrabold mb-6 text-white">¿Tu negocio ya tiene valor. <span className="italic text-accent">Ahora hay que encenderlo.</span></h2>
            <p className="text-gray-300 text-xl mb-8 max-w-2xl mx-auto font-medium">Haz que tu presencia digital esté al nivel de lo que realmente ofreces.</p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <motion.a 
                ...
                href="https://wa.me/525562189913?text=Hola,%20quiero%20empezar%20con%20Presencia%20Digital%20para%20mi%20negocio" 
                target="_blank" 
                rel="noreferrer"
              >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-2">
              ...
              <p className="text-gray-500 max-w-sm mb-6">Presencia Digital IA enciende negocios locales: mejor imagen, mejor atención y menos caos.</p>
              ...
              <p className="text-accent font-bold mt-2">
                <a 
                  ...
                  href="https://wa.me/525562189913?text=Hola,%20tengo%20una%20pregunta%20sobre%20Presencia%20Digital."
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  5562189913
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-500 text-sm">
                ...
                <li><a className="hover:text-accent transition-colors hover:translate-x-1 block" href="#proceso">Cómo funciona</a></li>
